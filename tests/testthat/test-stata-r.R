test_that("test wildwyoung against wyoung.ado", {
    ...
    #res_wyoung <- wyoung(models = res, param = "X1", B = 9999, nthreads = 1)

    #expect_equal(1, 1)
    # stata results
    #stata_res <- c(0.0010, 0.4166, 0.4166, 0.1179)

    #expect_equal(res_wyoung$pval, stata_res, tolerance = 0.1)
